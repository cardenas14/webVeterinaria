         ...
         <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
             <li class="nav-item dropdown">
                 ...
                 <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                     ...
                     <li>
                         <a class="dropdown-item" href="../TallerWeb-avance2/controlador/ControlUsuario.php?accion=CerrarSesion">Salir</a>
                     </li>
                 </ul>
             </li>
         </ul>
         ...
         <div id="layoutSidenav_content">
             <main>
                 <div class="container-fluid px-4">
                     <h1 class="mt-4">Productos mas vendidos</h1>
                     <ol class="breadcrumb mb-4">
                         <li class="breadcrumb-item active">Productos</li>
                     </ol>

                     <div>
                         <a href="reporte_producto_pdf.php" target="_blank"><button class="btn btn-danger mb-3" data-bs-toggle="modal" data-bs-target="#ModalProductoReg">
                                 Exportar en PDF
                             </button></a>
                     </div>
                     <div>
                         <a href="reporte_producto_excel.php"><button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#ModalProductoReg">
                                 Exportar en Excel
                             </button></a>
                     </div>
                     <!-- Tabla -->
                                     ...
                                     <?php
                                        ...
                                        ?>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <img src="data:image/jpg;base64,<?= base64_encode($row['Imagen']); ?>" width="50px" alt="">
