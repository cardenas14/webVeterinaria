         ...
         <div id="layoutSidenav_content">
             <main>
                 <div class="container-fluid px-4">
                     <h1 class="mt-4">Clientes mas frecuentes</h1>
                     <ol class="breadcrumb mb-4">
                         <li class="breadcrumb-item active">Clientes</li>
                     </ol>

                     <div>
                         <a href="reporte_cliente_pdf.php" target="_blank"><button class="btn btn-danger mb-3" data-bs-toggle="modal" data-bs-target="#ModalProductoReg">
                                 Exportar en PDF
                             </button></a>
                     </div>
                     <div>
                         <a href="reporte_cliente_excel.php"><button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#ModalProductoReg">
                                 Exportar en Excel
                             </button></a>
                     </div>
                     <!-- Tabla -->
                             ...
                             <table id="datatablesSimple">
                                 ...
                                 <tbody>
                                     ...
                                     <?php
                                        ...
                                        $sql = "SELECT h.IdHistorial,h.DNI, e.Nombre,l.Nombres,h.Precio,h.FechaAtencion,h.Descripcion FROM historial_cliente h INNER JOIN especialidad e ON e.IdEspecialidad = h.IdEspecilidad
                                        INNER JOIN login_empleado l ON l.IdEmpleado = h.IdEmpleado";
